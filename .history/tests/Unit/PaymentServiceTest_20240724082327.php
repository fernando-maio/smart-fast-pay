...
class PaymentServiceTest extends TestCase
{
    ...
    public function testCreatePaymentWithPaymentProcessingException()
    {
        ...
        $paymentMock = Mockery::mock($paymentService)->shouldReceive('processPayment')->andThrow(new \Exception('Payment processing failed'));
        $paymentMock->shouldReceive('processPayment')->andThrow(new \Exception('Payment processing failed'));
