...
class PaymentByIdServiceTest extends TestCase
{
    ...
    public function testProcessPayment()
    {
        ...
        $result = $this->paymentServiceprocessPayment();
    ...
    public function testCalculateFeeWithValidMethod()
    {
        ...
        $fee = $this->paymentServicecalculateFee($amount, $paymentMethodSlug);
    ...
    public function testCalculateFeeWithInvalidMethod()
    {
        ...
        $this->paymentServicecalculateFee($amount, $paymentMethodSlug);
    }
}
