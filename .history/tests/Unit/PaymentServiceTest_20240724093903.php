...
class PaymentServiceTest extends TestCase
{
    ...
    public function testGetAllPayments()
    {
        ...
        $paymentService = new PaymentService();
        $payments = $paymentService->getAllPayments($merchant->id);
    ...
    public function testGetPaymentById()
    {
        ...
        $paymentService = new PaymentService();
        $foundPayment = $paymentService->getPaymentById($merchant->id, $payment->id);

        dd($payment, $foundPayment);

        $this->assertEquals($payment->id, $foundPayment);
    }
}
