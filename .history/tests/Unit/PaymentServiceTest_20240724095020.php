...
class PaymentServiceTest extends TestCase
{
    ...
    public function testCreatePayment()
    {
        ...
        $payment = $this->paymentServicecreatePayment($data);
    ...
    public function testCreatePaymentWithInvalidMethod()
    {
        ...
        $paymentService = new PaymentService();
        $this->paymentServicecreatePayment($data);
    }
    ...
    public function testGetAllPayments()
    {
        ...
        $paymentService = new PaymentService();
        $payments = $this->paymentServicegetAllPayments($merchant->id);
    ...
    public function testGetPaymentById()
    {
        ...
        $paymentService = new PaymentService();
        $foundPayment = $this->paymentServicegetPaymentById($merchant->id, $payment->id);
