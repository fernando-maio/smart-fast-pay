 ...
 *     @OA\Property(property="description", type="string", example="Payment for services rendered"),
 *     @OA\Property(property="amount", type="number", format="float", example="100.00"),
 *     @OA\Property(property="payment_method_slug", type="string", example="credit_card"),
 * )
 */
